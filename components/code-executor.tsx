...
export function CodeExecutor({
  ...
  const codeLines = [
    ...
    { text: 'const job = await fetchJob("linkedin.com/jobs/...")', indent: 0 },
    { text: "", indent: 0 },
    { text: "try {", indent: 0 },
    { text: "  await applyToJob({", indent: 1 },
    { text: `    title: "${currentJob.title}",`, indent: 2 },
    { text: `    requirements: ${JSON.stringify(currentJob.requirements.slice(0, 1))}`, indent: 2 },
    { text: "  })", indent: 1 },
